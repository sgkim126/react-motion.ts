...
/***/ function(module, exports, __webpack_require__) {
	...
	var Demo_1 = __webpack_require__(159);
	ReactDOM.render(React.createElement(Demo_1.default, null), document.querySelector('#content'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var react_motion_1 = __webpack_require__(160);
	...
	var Demo = function (_React$Component) {
	    ...
	    _createClass(Demo, [{
	        ...
	        key: 'handleDone',
	        value: function handleDone(doneKey) {
	            this.setState({
	                todos: this.state.todos.map(function (todo) {
	                    var key = todo.key;
	                    var _todo$data = todo.data;
	                    var text = _todo$data.text;
	                    var isDone = _todo$data.isDone;
	        ...
	        value: function handleToggleAll() {
	            var allNotDone = this.state.todos.every(function (_ref2) {
	                var data = _ref2.data;
	                return data.isDone;
	            });
	            this.setState({
	                todos: this.state.todos.map(function (_ref3) {
	                    var key = _ref3.key;
	                    var text = _ref3.data.text;
	                    return { key: key, data: { text: text, isDone: !allNotDone } };
	                })
	            });
	        }
	    }, {
	        ...
	        value: function handleClearCompleted() {
	            this.setState({ todos: this.state.todos.filter(function (_ref4) {
	                    var data = _ref4.data;
	                    return !data.isDone;
	                }) });
	        }
	        ...
	        key: 'handleDestroy',
	        value: function handleDestroy(date) {
	            this.setState({ todos: this.state.todos.filter(function (_ref5) {
	                    var key = _ref5.key;
	        ...
	        value: function getStyles() {
	            ...
	            return todos.filter(function (_ref6) {
	                var _ref6$data = _ref6.data;
	                var isDone = _ref6$data.isDone;
	                var text = _ref6$data.text;
	                ...
	                return Object.assign({}, todo, { style: {
	                        height: react_motion_1.spring(60, react_motion_1.presets.gentle),
	                        opacity: react_motion_1.spring(1, react_motion_1.presets.gentle)
	                    } });
	        ...
	        value: function willLeave() {
	            return {
	                height: react_motion_1.spring(0),
	        ...
	        value: function render() {
	            ...
	            var itemsLeft = todos.filter(function (_ref7) {
	                var isDone = _ref7.data.isDone;
	                return !isDone;
	            }).length;
	            return React.createElement(
	                ...
	                React.createElement(
	                    ...
	                    React.createElement(
	                        ...
	                        React.createElement('input', { autoFocus: true, className: 'new-todo', placeholder: 'What needs to be done?', value: value, onChange: this.handleChange.bind(this) })
	                    )
	                ),
	                React.createElement(
	                    'section',
	                    { className: 'main' },
	                    React.createElement('input', { className: 'toggle-all', type: 'checkbox', checked: itemsLeft === 0, style: { display: todos.length === 0 ? 'none' : 'inline' }, onChange: this.handleToggleAll.bind(this) }),
	                    React.createElement(
	                        react_motion_1.TransitionMotion,
	                        { defaultStyles: this.getDefaultStyles(), styles: this.getStyles(), willLeave: this.willLeave.bind(this), willEnter: this.willEnter.bind(this) },
	                        function (styles) {
	                            return React.createElement(
	                                'ul',
	                                { className: 'todo-list' },
	                                styles.map(function (_ref8) {
	                                    var key = _ref8.key;
	                                    var style = _ref8.style;
	                                    var _ref8$data = _ref8.data;
	                                    var isDone = _ref8$data.isDone;
	                                    var text = _ref8$data.text;
	                                    return React.createElement(
	                                        'li',
	                                        { key: key, style: style, className: isDone ? 'completed' : '' },
	                                        React.createElement(
	                                            'div',
	                                            { className: 'view' },
	                                            React.createElement('input', { className: 'toggle', type: 'checkbox', onChange: _this2.handleDone.bind(_this2, key), checked: isDone }),
	                                            React.createElement(
	                                                'label',
	                                                null,
	                                                text
	                                            ),
	                                            React.createElement('button', { className: 'destroy', onClick: _this2.handleDestroy.bind(_this2, key) })
	                                        )
	                                    );
	                                })
	                            );
	                ...
	                React.createElement(
	                    ...
	                    React.createElement(
	                        ...
	                        React.createElement(
	                            ...
	                            React.createElement(
	                                'a',
	                                { className: selected === 'all' ? 'selected' : '', onClick: this.handleSelect.bind(this, 'all') },
	                                'All'
	                            )
	                        ),
	                        React.createElement(
	                            ...
	                            React.createElement(
	                                'a',
	                                { className: selected === 'active' ? 'selected' : '', onClick: this.handleSelect.bind(this, 'active') },
	                                'Active'
	                            )
	                        ),
	                        React.createElement(
	                            ...
	                            React.createElement(
	                                'a',
	                                { className: selected === 'completed' ? 'selected' : '', onClick: this.handleSelect.bind(this, 'completed') },
	                                'Completed'
	                            )
	                        )
	                    ),
	                    React.createElement(
	                        'button',
	                        { className: 'clear-completed', onClick: this.handleClearCompleted.bind(this) },
	                        'Clear completed'
	                    )
	                )
	            );
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Motion = __webpack_require__(161);

	exports.Motion = _interopRequire(_Motion);

	var _StaggeredMotion = __webpack_require__(168);

	exports.StaggeredMotion = _interopRequire(_StaggeredMotion);

	var _TransitionMotion = __webpack_require__(169);
	...
	var _reorderKeys = __webpack_require__(173);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _mapToZero = __webpack_require__(162);
	...
	var _stepper3 = __webpack_require__(164);

	var _stepper4 = _interopRequireDefault(_stepper3);

	var _performanceNow = __webpack_require__(165);
	...
	var _shouldStopAnimation = __webpack_require__(167);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _mergeDiff = __webpack_require__(170);
