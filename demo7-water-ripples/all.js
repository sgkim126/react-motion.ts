...
/***/ function(module, exports, __webpack_require__) {
	...
	var leavingSpringConfig = { stiffness: 60, damping: 15 };
	...
	var Demo = function (_React$Component) {
	    ...
	    _createClass(Demo, [{
	        ...
	        key: 'willLeave',
	        value: function willLeave(styleCell) {
	            return Object.assign({}, styleCell.style, {
	                opacity: react_motion_1.spring(0, leavingSpringConfig),
	                scale: react_motion_1.spring(2, leavingSpringConfig)
	            });
	        }
	    }, {
	        key: 'render',
	        value: function render() {
	            ...
	            var _state$mouse = _slicedToArray(_state.mouse, 2);

	            var mouseX = _state$mouse[0];
	            var mouseY = _state$mouse[1];
	            var now = _state.now;

	            var styles = mouseX == null ? [] : [{
	                key: now,
	                style: {
	                    opacity: react_motion_1.spring(1),
	                    scale: react_motion_1.spring(0),
	                    x: react_motion_1.spring(mouseX),
	                    y: react_motion_1.spring(mouseY)
	                }
	            }];
	            return React.createElement(
	                react_motion_1.TransitionMotion,
	                { willLeave: this.willLeave.bind(this), styles: styles },
	                function (circles) {
	                    return React.createElement(
	                        'div',
	                        { onMouseMove: _this2.handleMouseMove.bind(_this2), onTouchMove: _this2.handleTouchMove.bind(_this2), className: 'demo7' },
	                        circles.map(function (_ref2) {
	                            var key = _ref2.key;
	                            var _ref2$style = _ref2.style;
	                            var opacity = _ref2$style.opacity;
	                            var scale = _ref2$style.scale;
	                            var x = _ref2$style.x;
	                            var y = _ref2$style.y;
	                            return React.createElement('div', { key: key, className: 'demo7-ball', style: {
	                                    opacity: opacity,
	                                    scale: scale,
