	    ...
	    _createClass(Demo, [{
	        ...
	        value: function render() {
	            return React.createElement(
	                ...
	                React.createElement(
	                    'button',
	                    { onMouseDown: this.handleMouseDown.bind(this), onTouchStart: this.handleTouchStart.bind(this) },
	                    'Toggle'
	                ),
	                React.createElement(
	                    react_motion_1.Motion,
	                    { style: { x: react_motion_1.spring(this.state.open ? 400 : 0) } },
	                    function (_ref) {
	                        var x = _ref.x;
	                        return(
	                            ...
	                            React.createElement(
	                                'div',
	                                { className: 'demo0' },
	                                React.createElement('div', { className: 'demo0-block', style: {
